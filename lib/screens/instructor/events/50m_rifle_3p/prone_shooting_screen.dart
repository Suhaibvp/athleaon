...
class ProneShootingScreen extends StatefulWidget {
...
final List<ShotGroup>?existingShotGroups;
  ...
  @override
  State<ProneShootingScreen> createState() => _ProneShootingScreen();
}

class _ProneShootingScreen extends State<ProneShootingScreen> {
