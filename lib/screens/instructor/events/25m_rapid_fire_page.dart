...
import '25m_rapid_fire/day1_shooting_screen.dart';
import '25m_rapid_fire/rapid_session_report.dart'; // ✅ Import report screen

class RapidFirePage extends StatelessWidget {
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          final subSessionId = '${sessionId}_${subEvent.toLowerCase().replaceAll(' ', '_')}';
  ...
  Future<void> _openReportScreen(
    ...
    final reportData = PrecisionSessionReportData(
      ...
      eventType: '25m Rapid Fire', // ✅ Different event type
  ...
  Future<void> _openShootingScreen(
    ...
    if (sessionData != null && sessionData['hasShots'] == true) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Day1ShootingScreen(
            sessionId: subSessionId,
            sessionName: '$sessionName - $subEvent',
            shotsPerTarget: shots,
